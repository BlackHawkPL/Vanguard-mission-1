...
NEWTAB("1. SITUATION: FRIENDLY")
	...
	<br/>
	<br/>1.c.3.) Adjacent Units: Battalion Scouts (Ghost Platoon) are already occupying AA Ghost in sector approx. 1km North of BN AA. Battalion Mortars joined Ghost Platoon. Brigade Air-Defense-Artillery (ADA) has also joined Ghost Platoon. All other Battalion forces are at AA Vanguard. Brigade Rotary Attack assets are currently operating in sector and will have limited capabilities to support our Battalion’s maneuver.\
ENDTAB;
